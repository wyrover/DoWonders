...
%REDIRECTOR% nul cparser-cl-64-a.log cparser-cl-64-a.log %CPARSER% --nologo -32 --suffix -cl-64-a.dat win32.h %PREDEF_COMMON% -DMBCS -D_MBCS
%REDIRECTOR% nul cparser-cl-64-w.log cparser-cl-64-w.log %CPARSER% --nologo -32 --suffix -cl-64-w.dat win32.h %PREDEF_COMMON% -DUNICODE -D_UNICODE
