...
%REDIRECTOR% nul sanitize-cl-32-a.log sanitize-cl-32-a.log %CC% -DMBCS -D_MBCS -D_MT=1 -D_MSC_VER=1700 -DSORTPP_PASS=1 sanitize-cl-32-a.c
if ERRORLEVEL 1 goto error
...
if ERRORLEVEL 1 goto error
%REDIRECTOR% nul sanitize-cl-32-w.log sanitize-cl-32-w.log %CC% -DUNICODE -D_UNICODE -D_MT=1 -D_MSC_VER=1700 -DSORTPP_PASS=1 sanitize-cl-32-w.c
if ERRORLEVEL 1 goto error
