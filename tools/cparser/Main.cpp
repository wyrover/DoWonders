...
# ifdef __GNUC__
    "// CParser 0.3.7 (64-bit) for gcc        //\n"
# elif defined(__clang__)
    "// CParser 0.3.7 (64-bit) for clang      //\n"
# elif defined(_MSC_VER)
    "// CParser 0.3.7 (64-bit) for cl (MSVC)  //\n"
# else
#  error You lose!
# endif
#else   // !64-bit
# ifdef __GNUC__
    "// CParser 0.3.7 (32-bit) for gcc        //\n"
# elif defined(__clang__)
    "// CParser 0.3.7 (32-bit) for clang      //\n"
# elif defined(_MSC_VER)
    "// CParser 0.3.7 (32-bit) for cl (MSVC)  //\n"
# else
#  error You lose!
# endif
#endif  // !64-bit
