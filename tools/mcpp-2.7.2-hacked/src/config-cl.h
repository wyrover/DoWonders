...
#define ISO2022_JP_IS_ESCAPE_FREE TRUE
...
#define MINGW_DIRECTORY "C:/mingw-builds/x32-4.8.1-win32-dwarf-rev5/mingw32"

/* Define root directory of MSYS. */
#define MSYS_ROOT_DIRECTORY "C:/mingw-builds/msys/1.0"
