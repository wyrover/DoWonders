...
SET REDIRECTOR=..\tools\redirector\x64\Debug\redirector64.exe
...
SET PREDEF_COMMON=-D_M_AMD64=1 -D_MT=1 -D_WIN32=1 -D_MSC_VER=1700 -D__x86_64=1 -D__x86_64__=1 -D_WIN64=1
